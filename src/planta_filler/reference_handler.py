# =============================================================================
# reference_handler.py - Reference Day File Management
# =============================================================================
# This module handles loading, saving, and auto-adapting reference day files
# for the copy_reference strategy. Reference files contain hour distributions
# that serve as templates for filling timesheets.
#
# Key feature: Automatic dimension adaptation
# When the number of task rows in PLANTA changes, this module automatically:
# 1. Backs up the old reference file
# 2. Creates a new reference file with the correct number of slots
#
# Main functions:
# - load_reference_day(): Load reference values from CSV file
# - save_reference_day(): Save reference values to CSV file
# - ensure_reference_file(): Create/adapt reference file to match slot count
# - create_default_reference(): Generate default equal-weight reference
# =============================================================================
